...
class TestChatEndpoints:
    ...
    def test_kb_id(self, client):
        ...
        client.post(f"/agents/{kb_id}/json", json={"json_data": json_data})
    ...
    def test_chat_endpoint(self, client, test_kb_id):
        ...
        response = client.post(
            f"/agents/{test_kb_id}/chat", json={"message": "Tell me about your product"}
        )
    ...
    def test_human_response_endpoint(self, client, test_kb_id):
        ...
        client.post(
            f"/agents/{test_kb_id}/chat", json={"message": "What are your products?"}
        )
    ...
    def test_bot_chat_endpoint(self, client):
        ...
        response = client.post(
            f"/bots/{test_bot_id}/chat", json={"message": "Hello bot"}
        )
    ...
    def test_invalid_kb_id_chat(self, client):
        ...
        response = client.post(
            f"/agents/{invalid_kb_id}/chat", json={"message": "Test with invalid KB"}
        )
        assert response.status_code in [
            status.HTTP_404_NOT_FOUND,
            status.HTTP_500_INTERNAL_SERVER_ERROR,
