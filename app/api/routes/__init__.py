...
from app.api.routes.chat import router as chat_router, public_router as chat_public_router
...
router.include_router(chat_public_router)  # Public chat endpoints (no auth required)
