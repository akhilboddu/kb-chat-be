...
async def check_subscription(reference: str, user_id: str = Query(..., description="User ID to update subscription")):
    """
        ...
        async with httpx.AsyncClient() as client:
            ...
            if response.status_code == 200 and response_data.get("status"):
                ...
                if payment_data["status"] == "success":
                    ...
                    update_success = await update_user_subscription(user_id, payment_data, plan_name)
