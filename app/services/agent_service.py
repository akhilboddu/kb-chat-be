...
from app.models.agent import (
    CreateAgentResponse, KBInfo, KBContentItem, KBContentResponse,
    CleanupResponse, StatusResponse, AgentConfigResponse
)
...
class AgentService:
    ...
    @staticmethod
    def populate_agent_from_json(kb_id: str, json_data: Dict[str, Any]) -> StatusResponse:
        """
        ...
        try:
            ...
            if success:
                ...
                raise Exception("Failed to add extracted JSON content to the knowledge base.")
    ...
    def delete_agent(kb_id: str) -> StatusResponse:
        ...
        if all_deleted:
            ...
            raise Exception(f"Failed to delete knowledge base {kb_id} and all associated metadata due to internal errors.")
    ...
    @staticmethod
    def get_kb_content(kb_id: str, limit: Optional[int] = None, offset: Optional[int] = None) -> KBContentResponse:
        """
    ...
    def update_agent_config(kb_id: str, update_data: Dict[str, Any]) -> StatusResponse:
        ...
        try:
            ...
            if success:
                ...
                raise Exception("Failed to update agent configuration due to an internal database error.")
        except Exception as e:
